...
public class Task01 {
    public static int start(int hour1, int minute1, int second1,
                            int hour2, int minute2, int second2) {
        if (hour1 < 0 || hour1 > 23
                || minute1 < 0 || minute1 > 59
                || second1 < 0 || second1 > 59
                || hour2 < 0 || hour2 > 23
                || minute2 < 0 || minute2 > 59
                || second2 < 0 || second2 > 59) {
            return -1;
        }

        return Math.abs((hour1 * 3600 + minute1 * 60 + second1)
